...
<img src="Exercise2_files/figure-html/unnamed-chunk-46-1.png" width="672" />
...
<img src="Exercise2_files/figure-html/unnamed-chunk-47-1.png" width="672" />
...
<img src="Exercise2_files/figure-html/unnamed-chunk-48-1.png" width="672" />
...
We could also visualise the solution from the exercise as a barplot with `ggplot2`, using geom_bar(). For example:
...
<img src="Exercise2_files/figure-html/unnamed-chunk-58-1.png" width="672" />

```r
depthplot + geom_jitter()
```

<img src="Exercise2_files/figure-html/unnamed-chunk-58-2.png" width="672" />

```r
depthplot + geom_col(aes(fill = species))
```

<img src="Exercise2_files/figure-html/unnamed-chunk-58-3.png" width="672" />

```r
depthplot + geom_boxplot()
```

<img src="Exercise2_files/figure-html/unnamed-chunk-58-4.png" width="672" />

```r
depthplot + geom_line()
```

<img src="Exercise2_files/figure-html/unnamed-chunk-58-5.png" width="672" />

```r
depthplot + geom_area(aes(fill = species))
```

<img src="Exercise2_files/figure-html/unnamed-chunk-58-6.png" width="672" />
...
<img src="Exercise2_files/figure-html/unnamed-chunk-59-1.png" width="672" />
