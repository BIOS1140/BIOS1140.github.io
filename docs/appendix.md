...
2. The document should contain **all the code** you used to complete the assignment. This should be in a font that's suitable for programming (i.e., where all characters have the same width), for example Source code pro.
