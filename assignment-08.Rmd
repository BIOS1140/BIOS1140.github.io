...
a) Calculate the mean pairwise Fst and also the mean pairwise dxy for the house versus the spanish sparrow. _N.B. if you use a tidyverse solution, it may be easier to use t() to transpose and see the final result_

b) Use a boxplot to visualise the distribution of $F_{ST}$ and $d_{XY}$ for the house versus bactrianus and the house versus spanish. _Hint: You need to use pivot_longer on the columns containing_ $F_{ST}$ _and_ $d_{XY}$ _data respectively._

c) Draw a composite plot (fst, nucleotide diversity, dxy) for the house versus Spanish comparison. Is there a similar pattern to the house/bactrianus data we examined in the tutorial?
