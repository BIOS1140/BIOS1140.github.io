...
With these steps carried out, you can then establish the vcf path like so:

```{r, eval = FALSE, echo = TRUE, results = 'hide', message = FALSE, warning = FALSE, error = FALSE}
vcf_file <- system.file("./sparrow_chr8_downsample.vcf.gz", package = "GenoPop")
```
...
pi_windows <- Pi(vcf_file, exclude_ind = c(bactrianus, spanish, italian, tree),
...
pi_windows <- as_tibble(test_windows)
