...
Use what you have learned about vectors to calculate the population proportions of all the Nordic countries in a single operation. Save it to an object with a good name.
...
We get a nice scatterplot of those data, showing a correlation between these variables. 
