...
::: {.green}
**Important concept:**\
-  `filter()` is used to select specific rows. Example: `filter(height < 100)`
-  `select()` is used to select specific columns. Example: `select(name, height)`
:::
...
## Reshaping data with pivot_longer() {#pivot_longer}
